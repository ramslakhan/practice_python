...
Event_Created=my_event_handler.on_created = FilePoller.OnPolling.on_created
#print(Event_Created)
Event_Modified=my_event_handler.on_modified = FilePoller.OnPolling.on_modified
#print(Event_Modified)
